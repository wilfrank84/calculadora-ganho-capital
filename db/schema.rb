...
ActiveRecord::Schema.define(version: 2019_02_04_140705) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "stock_exchange_transactions", force: :cascade do |t|
  ...
  add_foreign_key "stock_exchange_transactions", "users"
end
